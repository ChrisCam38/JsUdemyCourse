...
const poll = {
  ...
  regiterNewAnswer() {
    ...
    //Register answer  
    typeof answer === 'number' && answer < answer.length && this.answers[answer]++;
...
//poll.regiterNewAnswer();
document.querySelector('.poll').addEventListener('click', poll.regiterNewAnswer.bind(poll));
